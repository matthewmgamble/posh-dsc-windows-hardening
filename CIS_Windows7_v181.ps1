...
Configuration CIS_Windows7_v181 {
    param (
    ...
    Node $NodeName {
       ...
       # 2.2.1 (L1) Ensure 'Access Credential Manager as a trusted caller' is set to 'No One'
        ...
        SecurityOption AccountSecurityOptions {
            ...
            Interactive_logon_Message_text_for_users_attempting_to_log_on = 'This computer system is the property of IGM Financial and is for authorised use by employees and designated contractors only. By continuing to use this system you indicate your awareness of and consent to these terms and conditions of use.It is the users responsibility to LOG OFF IMMEDIATELY if you do not agree to the conditions stated in this notice.'
